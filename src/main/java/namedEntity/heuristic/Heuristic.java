...
public abstract class Heuristic implements Serializable {
    ...
    static {
        ...
        mapa.put("Regeneron Pharmaceuticals",
                new NamedEntity("Regeneron Pharmaceuticals", new Category("Organization"), new Topic("OtherTopics"),
                        0));
        ...
        mapa.put("Capital One",
                new NamedEntity("Capital One", new Category("Organization"), new Topic("OtherTopics"), 0));
        mapa.put("Chase Bank",
                new NamedEntity("Chase Bank", new Category("Organization"), new Topic("OtherTopics"), 0));
        ...
        mapa.put("Wendy McMahon",
                new NamedEntity("Wendy McMahon", new Category("Person"), new Topic("OtherTopics"), 0));
        ...
        mapa.put("Scott Galloway",
                new NamedEntity("Scott Galloway", new Category("Person"), new Topic("OtherTopics"), 0));
        mapa.put("Niraj Chokshi",
                new NamedEntity("Niraj Chokshi", new Category("Person"), new Topic("OtherTopics"), 0));
        mapa.put("Jerome H. Powell",
                new NamedEntity("Jerome H. Powell", new Category("Person"), new Topic("Politics"), 0));
        ...
        mapa.put("Newark Airport",
                new NamedEntity("Newark Liberty International Airport", new Category("Place"), new Topic("OtherTopics"),
                        0));
        ...
        mapa.put("SPAC",
                new NamedEntity("Special Purpose Acquisition Company", new Category("Product"),
                        new Topic("OtherTopics"), 0));
        ...
        mapa.put("Cryptocurrency",
                new NamedEntity("Cryptocurrency", new Category("Product"), new Topic("OtherTopics"), 0));
        ...
        mapa.put("Housing Crunch",
                new NamedEntity("Housing Crunch", new Category("Event"), new Topic("OtherTopics"), 0));
